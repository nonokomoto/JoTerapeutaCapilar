...
import { togglePostReaction } from "@/app/cliente/actions";
...
export function PostReactionBar({ postId, reactions }: PostReactionBarProps) {
    ...
    const handleReaction = (reaction: ReactionType) => {
        ...
        startTransition(async () => {
            await togglePostReaction(postId, reaction);
        });
    };
